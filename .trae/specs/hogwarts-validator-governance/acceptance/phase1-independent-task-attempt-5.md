# Phase 1 Independent Acceptance Task - Attempt 5
...
3. Inspect all 578 registry rows and their production consequences, including
   rows marked lexical and dead/retired.
4. Exercise positive and adversarial enforcement behavior for complete
   persisted identity/history, governance-file mutation, unregistered
   deletion, semantic mutation and retired-ID resurrection.
