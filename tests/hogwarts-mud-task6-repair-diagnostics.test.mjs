...
test('ordinary Performer accepts free-form historical-looking dialogue without regex rejection', async () => {
    const prompts = [];
    const claim =
        'Yesterday in the rain corridor, you hid my umbrella.';
    const workflow =
...
test('production low Opening does not reject literary past tense through regex', async () => {
    const prompts = [];
    const claimTextEn =
