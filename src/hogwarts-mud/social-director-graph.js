...
const RELATIONSHIP_DIMENSION_RANGES =
    Object.freeze({
...
const MODEL_RELATIONSHIP_EVIDENCE_FIELDS =
    new Set([
        'sourceActorId',
        'targetActorId',
        'sceneId',
...
const PERSISTED_RELATIONSHIP_EVIDENCE_FIELDS =
    new Set([
        'id',
...
const PERSISTED_RELATIONSHIP_EDGE_FIELDS =
    new Set([
        'id',
        'sourceActorId',
        'targetActorId',
...
const RESENTMENT_HARM_EVENT_KINDS =
    new Set([
        'insult',
        'humiliation',
        'threat',
...
const ACCEPTED_REPAIR_EVENT_KINDS =
    new Set([
        'accepted_apology',
        'accepted_compensation',
        'forgiveness',
...
const DEFINING_EVENT_KINDS =
    new Set([
        'betrayal',
        'sacrifice',
    ]);
const SIGNED_NEGATIVE_DIMENSIONS =
    new Set([
        'warmth',
        'trust',
        'respect',
...
const NON_BONDING_CLOSENESS_EVENT_KINDS =
    new Set([
        'introduction',
        'routine_interaction',
        'other',
    ]);
const STAGE_GATED_CLOSENESS_EVENT_KINDS =
    new Set([
        'gift',
        'praise',
    ]);
const CLOSENESS_STAGE_THRESHOLDS =
    Object.freeze([
        10,
        20,
        35,
...
const ACTIVE_EMOTION_DECAY_PER_TURN = 1;
